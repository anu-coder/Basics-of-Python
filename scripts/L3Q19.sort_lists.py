'''
Question: You are required to write a program 
to sort the (name, age, height) tuples by ascending order 
...
s = s.split(' ')
list_of_tuple = [tuple(elem.split(',')) for elem in s]
print(sorted(list_of_tuple))
